...
<input value={input} onChange={e =>setInput(e.target.value)} className="bg-gray-100 rounded-md text-black"type="text" name="email" placeholder="Enter Patient's Name">
</input>
</div>


<div className="bg-gray-100 w-full p-2 rounded-xl mb-2">
<input value={input1} onChange={e =>setInput1(e.target.value)} className="bg-gray-100 rounded-md text-black"type="number" name="email" placeholder="Age">
</input>
</div>


<div className="bg-gray-100 w-full p-2 rounded-xl mb-2">
<input value={input2} onChange={e =>setInput2(e.target.value)} className="bg-gray-100 rounded-md text-black"type="text" name="email" placeholder="Sex">
</input>
</div>
...
<div className="bg-gray-100 w-full p-2 rounded-xl mb-2">
<input value={input3} onChange={e =>setInput3(e.target.value)} className="bg-gray-100 rounded-md text-black"type="number" name="email" placeholder="Weight">
</input>
</div>


<div className="bg-gray-100 w-full p-2 rounded-xl mb-2">
<input value={input4} onChange={e =>setInput4(e.target.value)} className="bg-gray-100 rounded-md text-black"type="number" name="email" placeholder="Phone Number">
</input>
</div>


<div className="bg-gray-100 w-full p-2 rounded-xl mb-2">
<input value={input5} onChange={e =>setInput5(e.target.value)} className="bg-gray-100 rounded-md text-black"type="text" name="email" placeholder="Medical Problems">
</input>
</div>


<div className="bg-gray-100 w-full p-2 rounded-xl mb-2">
<input value={input6} onChange={e =>setInput6(e.target.value)} className="bg-gray-100 rounded-md text-black"type="text" name="email" placeholder="Miscellaneous">
</input>
</div>
...
<div className="bg-gray-100 w-full p-2 rounded-xl mb-2">
<input value={input7} onChange={e =>setInput7(e.target.value)} className="bg-gray-100 rounded-md text-black"type="number" name="email" placeholder="Bill">
</input>
</div>
